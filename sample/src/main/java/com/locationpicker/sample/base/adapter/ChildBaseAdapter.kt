...
abstract class ChildBaseAdapter<I,P>(items: ArrayList<I>? = null,parent:P?=null, @LayoutRes private var itemLayoutRes: Int) : RecyclerView.Adapter<com.locationpicker.sample.base.adapter.ChildBaseViewHolder<I, P>>() {

    private val items: MutableList<I> = items ?: ArrayList()
    private var parentAdapterPosition:P?=parent
    override fun onBindViewHolder(holder: com.locationpicker.sample.base.adapter.ChildBaseViewHolder<I, P>, position: Int) {
